...
cd "$SCRIPT_DIR"
crystal run site-scripts/generate-index.cr > "$SITE_DIR/index.json"
echo "  ✓ Generated index.json"

# Step 2: Render index page
echo "Step 2: Rendering index page..."
crystal run site-scripts/render-index.cr > "$SITE_DIR/index.html"
...
crystal run site-scripts/gen_site.cr
